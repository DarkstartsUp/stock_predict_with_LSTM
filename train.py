...
class Config:
    ...
    hidden_size = 3            # LSTM的隐藏层大小，也是输出大小
    lstm_layers = 2             # LSTM的堆叠层数
    conv_kernel = (3, 3)        # ConvLSTM卷积核的大小
    # TODO: conv_kernel = (5, 5)时，loss为nan
    ...
    patience = 60                # 训练多少epoch，验证集没提升就停掉
    ...
    # 路径参数
    train_data_path = './data/Astock_hs300.npy'
